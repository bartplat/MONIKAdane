...
agreguj_1rokpo_adm <- function(wsk2, wsk3, wsk4, podzial_grupy, rok_abso) {
  tryCatch({
    stopifnot(
      is.data.frame(wsk2) | is_tibble(wsk2),
    ...
    wskazniki_4 <- agreguj_wskazniki(
      ...
      liczebnosc_dziedziny = rozklad_liczebnosc(.data, wsk2, rok_abso, 12, dziedzina_kont, plc = NULL),
      liczebnosc_dyscypliny = rozklad_liczebnosc(.data, wsk2, rok_abso, 12, dyscyplina_wiodaca_kont, plc = NULL),
      dyscypliny_zawody = rozklad_zawody(.data, wsk2, rok_abso, 12, dyscyplina_wiodaca_kont),
      branze_zawody = rozklad_zawody(.data, wsk2, rok_abso, 12, branza_kont),
      dyscypliny_kob = rozklad_liczebnosc(.data, wsk2, rok_abso, 12, dyscyplina_wiodaca_kont, plc = "K"),
      dyscypliny_mez = rozklad_liczebnosc(.data, wsk2, rok_abso, 12, dyscyplina_wiodaca_kont, plc = "M")
    )
    ...
    wskazniki_3 <- agreguj_wskazniki(
      ...
      S3_07 = status_S3_mies(.data, rok_abso, 7, rok_abso, 7),
      S3_08 = status_S3_mies(.data, rok_abso, 8, rok_abso, 8),
      S3_09 = status_S3_mies(.data, rok_abso, 9, rok_abso, 9),
      S3_10 = status_S3_mies(.data, rok_abso, 10, rok_abso, 10),
      S3_11 = status_S3_mies(.data, rok_abso, 11, rok_abso, 11),
      S3_12 = status_S3_mies(.data, rok_abso, 12, rok_abso, 12),
      tab_s3_zaw = zawody_status_S3(.data, rok_abso, 12, rok_abso, 12),
